...
export const postJob = (values) => async (dispatch) => {
  ...
  dispatch({ type: "LOADING", payload: true });
  try {
    const response = await axios.post(url + "/api/jobs/postjob", values);
...
export const editJob = (values) => async (dispatch) => {
  dispatch({ type: "LOADING", payload: true });
  try {
    const response = await axios.post(url + "/api/jobs/editjob", values);
...
export const applyJob = (job) => async (dispatch) => {
  ...
  dispatch({ type: "LOADING", payload: true });
  try {
    const response = await axios.post(url + "/api/jobs/applyjob", {job , user});
